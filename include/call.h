...
struct call {
	...
	int			recording_on:1;
	int			rec_forwarding:1;
	int			dtls_ignore_endpoint_changes:1;
};
...
struct call *call_get_or_create_with_session_id(const str *callid, const str *session_id, const str *context, enum call_type);
