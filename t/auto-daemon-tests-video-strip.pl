...
offer('enable strip video sdp - offer', {'transport-protocol' => 'RTP/AVP', ICE => 'remove', replace => ['origin', 'session-connection'], 'rtcp-mux' => ['demux'] , flags => ['SDES-off', 'strip-video-sdp']}, <<SDP);
v=0
...
answer('enable strip video sdp - answer', {'transport-protocol' => 'UDP/TLS/RTP/SAVPF', ICE => 'force', replace => ['origin'], 'rtcp-mux' => ['offer'], flags => ['force-unified', 'SDES-off', 'strip-video-sdp']}, <<SDP);
v=0
